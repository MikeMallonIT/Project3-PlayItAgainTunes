...
import { Link,Box,Heading,Image,Text ,Flex, useColorModeValue} from '@chakra-ui/react';
...
const confetti = {
    light: {
      primary: 'cyan', // blue.400
      secondary: 'cyan', // blue.100
    },
  
    dark: {
      primary: 'cyan', // blue.900
      secondary: 'cyan', // blue.800
    },
  };
        ...
        {user ? (
          <>
            ...
            {user.orders.map((order) => (
              <Box key={order._id} className="my-2">
                <Heading>
